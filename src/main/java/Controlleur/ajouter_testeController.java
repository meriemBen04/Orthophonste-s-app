...
public class ajouter_testeController {
    ...
    @FXML
    void chercher_dossier(KeyEvent event) {
    ...
    void retour(ActionEvent event) {
        try {
            ...
            Parent nextPage = FXMLLoader.load(getClass().getResource("/com/example/tp_poo/Testes.fxml"));
            Stage Scene = (Stage) ((Node)event.getSource()).getScene().getWindow();
            javafx.scene.Scene scene = new Scene(nextPage, 1000, 670);
            Scene.setScene(scene);
